    ...
    <div v-if="apps" class="fadeIn">
      <div v-if="!seeMoreApps">
        <v-row no-gutters>
          <v-col
            lg="2"
            cols="12"
            v-for="(item, i) in apps_cards.group1"
            :key="'B' + i"
            class="mx-auto"
          >
            <div>
              <a :href="item.link" target="_blank">
                <div
                  ...
                  :class="lights ? 'cards-dark' : 'cards-light'"
                >
                  <v-img class="card-img white--text align-end" :src="item.img">
                  ...
                  <v-row>
                    <v-col
                      ...
                      lg="4"
                      v-for="(item, i) in item.tech_icons"
                      :key="'C' + i"
                      ><v-icon class="tech-icon">{{ item.techicon }}</v-icon>
                      <p class="tech-name">{{ item.techname }}</p></v-col
                    >
                  </v-row>
                  <p class="pb-0 card-subtitle">
                    <v-divider></v-divider>
      ...
      <div v-if="seeMoreApps" class="fadeIn">
        <v-row no-gutters>
          ...
          <v-col
            lg="2"
            v-for="(item, i) in apps_cards.group2"
            :key="'D' + i"
            class="mx-auto"
          >
            <a :href="item.link" target="_blank">
      ...
      apps_cards: {
        group1: [
          ...
          },
          {
            ...
            tech_icons: [
              { techname: 'Vuejs', techicon: 'mdi-vuejs' },
              { techname: 'The Movie Database API + REST countries', techicon: 'mdi-api' },
              { techname: 'HTML', techicon: 'mdi-language-html5' },
              { techname: 'CSS', techicon: 'mdi-language-css3' },
              { techname: 'SCSS', techicon: 'mdi-sass' },
              { techname: 'JavaScript', techicon: 'mdi-language-javascript' },
          ...
          },
          {
            ...
            tech_icons: [
              { techname: 'Vuejs', techicon: 'mdi-vuejs' },
              { techname: 'Google Books API + The New York Times API', techicon: 'mdi-api' },
              { techname: 'HTML', techicon: 'mdi-language-html5' },
              { techname: 'CSS', techicon: 'mdi-language-css3' },
              { techname: 'SCSS', techicon: 'mdi-sass' },
              { techname: 'JavaScript', techicon: 'mdi-language-javascript' },
        ...
        group2: [
          ...
          },
          {
            ...
            subtitle:
              'Login / Register system using Firebase and Google authenticantion system',
